                    ...
                    <form action="{{ route('admin.operators.update', $operatorById->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="sdesc" name="sdesc" placeholder="Short Description" value="{{ $operatorDetailsById['shortdesc'] }}">
                            </div>
                            <div class="form-group col-md-12 col-sm-12">
                                <label for="email">Description</label>
                                <textarea class="form-control" id="content" name="desc" placeholder="Description">{{ $operatorDetailsById['description'] }}</textarea>
                            </div>                            
                        </div>   
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="email">Seating Plan I</label>
                            <textarea class="form-control" id="seating1" name="seating1" placeholder="Description">{{ $operatorDetailsById['merchant_details'] }}</textarea>
                        </div>
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="email">Seating Plan II</label>
                            <textarea class="form-control" id="seating2" name="seating2" placeholder="Description">{{ $operatorDetailsById['rightbanner_code'] }}</textarea>
                        </div>
                        <div class="form-group col-md-12 col-sm-12">
                            <label for="email">Seating Plan III</label>
                            <textarea class="form-control" id="seating3" name="seating3" placeholder="Description">{{ $operatorDetailsById['search_right'] }}</textarea>
                        </div>                 
