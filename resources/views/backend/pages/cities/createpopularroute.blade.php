    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Popular City Mapping</h4>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.citymap.store') }}" method="POST" name="popularroutemap" id="popularroutemap" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="topnavpage">Navbar Top Page</label>
                                <select name="topnavpageid" id="topnavpageid" class="form-control">
                                    <option @readonly(true) value="">-Select Navbar Top Page-</option>
                                    <option value="27" selected="selected">Cities</option>
                                    {{-- <option value="29">Rail Providers</option> --}}
                                </select>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <select name="navsubpageid" id="navsubpageid" class="form-control">
                                    <option selected="selected" @readonly(true)>Select Page Name</option>
